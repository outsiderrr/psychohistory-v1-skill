...
1. **`/Users/outsider/Desktop/psychohistory/skill/characters/nuwa/[agent_id].md`**
   女娲原始蒸馏输出，保留作为审计记录。

2. **`/Users/outsider/Desktop/psychohistory/skill/characters/psychohistory/[agent_id].references.md`**
   **主产物**。按以下结构组织：
...
3. **`/Users/outsider/Desktop/psychohistory/skill/characters/psychohistory/[agent_id].json`**
